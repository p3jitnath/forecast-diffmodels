...
parser.add_argument('-run_name', help='Specify the run name (for eg. 64_128_woERA5_rot904_sep_3e-4)')
...
BASE_DIR = f"/vol/bitbucket/pn222/models/{RUN_NAME}/models/64_128_woERA5/"
...
with open(f"/vol/bitbucket/pn222/models/{RUN_NAME}/metrics.pkl", "wb") as file:
