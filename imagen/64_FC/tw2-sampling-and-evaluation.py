...
parser.add_argument('-run_name', help='Specify the run name (for eg. 64_FC_woERA5_rot904_3e-4)')
...
BASE_DIR = f"/vol/bitbucket/pn222/models/{RUN_NAME}/models/64_FC_woERA5/"
